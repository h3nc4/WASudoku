...
# CI image tag
ARG CI_IMAGE_TAG="latest@sha256:e9bd8d31e2c2578af177ba84a4d12bb3940f9f51b1e5ac849ca3dfa42ccde606"
...
################################################################################
# Nginx builder stage
FROM alpine:3.23@sha256:865b95f46d98cf867a156fe4a135ad3fe50d2056aa3f25ed31662dff6da4eb62 AS nginx-builder
ARG NGINX_VERSION
ARG PCRE2_VERSION
