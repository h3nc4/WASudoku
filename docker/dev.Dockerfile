...
FROM debian:13@sha256:181ecf074fdc824a42be4f84a7be2eba33c4ac298ae1ab15a4e69ed052bd9ec0 AS builder-base
...
################################################################################
# Debian main stage
FROM debian:13@sha256:181ecf074fdc824a42be4f84a7be2eba33c4ac298ae1ab15a4e69ed052bd9ec0 AS main
ARG USER
ARG UID
ARG GID
